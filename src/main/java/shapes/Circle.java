...
public final class Circle {
     ...
     */
    private final Integer numberKey;
     ...
     * @param numberKey a <code>Integer</code> search key for searching and deleting within an index.
     */
    public Circle(Integer numberKey) {
    ...
    /**
     *
     * @param numberKey a integer id number for searching and deleting from an index.
     * @param point a Cartesian coordinate using x and y float numbers.
     */
    public Circle(Integer numberKey, Point2D point) {
        this.numberKey = numberKey;
        this.point = point;
    ...
    private String getKey() {
        return Integer.toString(getNumberKey());
    }
    /**
